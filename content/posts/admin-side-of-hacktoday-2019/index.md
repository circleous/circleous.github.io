...
![logo](hacktoday-logo.png)_codepwnda ini bukan nama baru CSI, bukan juga organisasi atau pun komunitas baru._
...
![logo](hacktoday-stats.png)_top sekret unreleased challs_
...
![submission](hacktoday-rw-submission.png)_597 wrong submission. :(_
...
![cloudflare](hacktoday-cloudflare.png)_cloudflare_
...
![dns only](hacktoday-cf-dns-only.png)_dns only, kalau masih ingat ini dari not.codepwnda.id_
...
![NO SYSTEM IS SAFE](hacktoday-nosystemissafe.png)_thanks to siapa pun itu yang sudah membuat tamplate depes ini xD_
