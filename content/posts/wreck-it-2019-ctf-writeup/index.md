...
date = '2019-09-29T00:00:00+07:00'
draft = false
...
Buka file ELF tersebut pada IDA, pada tab strings-nya (Shift+F12) terdapat string `password` ![strings](wreckit-iot-strings.png) Cari xref-nya untuk string tersebut, ![strings](wreckit-iot-pwdxref.png) berikut hasil dekompilasi dari `sub_4002571`
...
Buka file dengan `uefitool` dan extract body dari `UiApp`, ![uiapp](wreckit-sehnsucht-uefitool.png)
...
![v124 xref](wreckit-sehnsucht-v124xref.png)
...
![solve](wreckit-sehnsucht-solve.png)
